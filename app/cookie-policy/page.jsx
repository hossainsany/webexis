        ...
        <section className='container mx-auto'>
            ...
            <div className='mb-10'>
                ...
                <p className='pb-5'>
                    ...
                    these third-party cookies can recognize your computer both when it visits the
            ...
            <div className='mb-10'>
                ...
                <p className='pb-5'>
                    ...
                    through our Website for advertising, analytics, and other purposes. This is
            ...
            <div className='mb-10'>
                ...
                <p className='pb-5'>
                    ...
                    more information. The following is information about how to manage cookies on
            ...
            <div className='mb-10'>
                ...
                <p className='pb-5'>
                    ...
                    allows us, for example, to monitor the traffic patterns of users from one page
            ...
            <div className='mb-10'>
                ...
                <p className='pb-5'>
                    ...
                    delete existing Flash Cookies, how to prevent Flash LSOs from being placed on
                    your computer without your being asked, and how to block Flash Cookies that are
            ...
            <div className='mb-10'>
                <h2 className='text-xl font-semibold pb-5'>Do you serve targeted advertising? </h2>
                <p className='pb-5'>
                    ...
                    details, or other details that directly identify you unless you choose to
                    provide these.
                </p>
            </div>
            ...
            <div>
                <h2 className='text-xl font-semibold pb-5'>Where can I get further information?</h2>
                <p className='pb-5'>
