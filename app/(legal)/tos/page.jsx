            ...
            <div className='container mx-auto'>
                ...
                <div id='intellectual ' className='mb-10'>
                    ...
                    <div className='your-use'>
                        ...
                        <div>
                            ...
                            <ul className='pb-5 pl-3'>
                                <li className='pb-1'>
                                    {' '}
                                    <span className='inline-block pr-2 h-[10px] w-[10px] mr-2 bg-accent rounded-full'></span>
                                ...
                                <li className='pb-1'>
                                    ...
                                    non-commercial use or internal business purpose; and
                                </li>
                                <li className='pb-1'>
                                    <span className='inline-block pr-2 h-[10px] w-[10px] mr-2 bg-accent rounded-full'></span>
                                    you may use the end product for business use.
                                </li>
                            </ul>
                        </div>
                        <p className='pb-5'>
                    ...
                    <div className='your-submission'>
                        ...
                        <p className='pb-5'>
                            <span className='font-semibold'>Submissions:</span> By directly sending
                        ...
                        <div className=''>
                            ...
                            <ul className='pb-5 pl-5'>
                                ...
                                <li className='pb-1'>
                                    <span className='inline-block pr-2 h-[10px] w-[10px] mr-2 bg-accent rounded-full'></span>
                                    and warrant and represent that your Submissions do not
                ...
                <div id='refund' className='mb-10'>
                    ...
                    <p className='pb-5'>
                        Please review our{' '}
                        <Link href='/refund-policy' className='hover:underline text-accent'>
                            Return Policy
                        </Link>{' '}
                ...
                <div id='user-generated' className='mb-10'>
                    ...
                    <p className='pb-5'>
                        ...
                        other material (collectively, &quot;Contributions&quot;). Contributions may
                ...
                <div id='third-party' className='mb-10'>
                    ...
                    <p className='pb-5'>
                        ...
                        the Services. Any purchases you make through Third-Party Websites will be
                        ...
                        us blameless from any losses sustained by you or harm caused to you relating
                        to or resulting in any way from any Third-Party Content or any contact with
                ...
                <div id='privacy-policy' className='mb-10'>
                    ...
                    <p className='pb-5'>
                        ...
                        United States, Germany, Singapore, Brazil, Australia, Russia, Japan, United
                        Kingdom, Canada, and India. If you access the Services from any other region
                        ...
                        United States, Germany, Singapore, Brazil, Australia, Russia, Japan, United
                        Kingdom, Canada, and India, then through your continued use of the Services,
                        you are transferring your data to the United States, Germany, Singapore,
                        Brazil, Australia, Russia, Japan, United Kingdom, Canada, and India, and you
                ...
                <div id='dispute' className='mb-10'>
                    ...
                    <div>
                        ...
                        <p className='pb-5'>
                            ...
                            or claim related to these Legal Terms brought by either you or us, the
                            Parties agree to first attempt to negotiate any Dispute informally for
                    ...
                    <div>
                        ...
                        <p className='pb-5'>
                            ...
                            between the Parties individually. No arbitration shall be joined with
                            any other proceeding, and there is no right or authority for any Dispute
                    ...
                    <div>
                        ...
                        <p className='pb-5'>
                            ...
                            including Disputes related to intellectual property rights, theft,
                            piracy, invasion of privacy, or unauthorized use, and claims for
                            injunctive relief.
                        </p>
                    </div>
                </div>
                ...
                <div id='disclaimer' className='mb-10'>
                    ...
                    <p className='pb-5'>
                        ...
                        CONNECTION WITH THE SERVICES AND YOUR USE THEREOF. WE MAKE NO WARRANTIES OR
                        ...
                        SERVICES. WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY ERRORS,
                        MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS, PERSONAL INJURY OR
                        PROPERTY DAMAGE, UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR
                        ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED
                        THEREIN, INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SERVICES,
                        BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE TRANSMITTED TO OR THROUGH THE
                        SERVICES BY ANY THIRD PARTY, AND/OR ERRORS OR OMISSIONS IN ANY CONTENT AND
                ...
                <div id='limitation' className='mb-10'>
                    ...
                    <p className='pb-5'>
                        To the fullest extent permitted by law, we disclaim all warranties, and we
                        will not be responsible for monitoring any transaction between you and any
