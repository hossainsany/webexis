...
const Cards = ({ title, desc, img, imgAlt, index }) => {
    ...
    return (
        <motion.div
            ...
            className='bg-lightBg-alt dark:bg-tertiary rounded p-4 flex flex-col first:flex-col  md:first:flex-row  last:flex-col first:col-span-1 md:first:col-span-2 last:col-span-1 md:last:col-span-2 md:last:flex-row transition-all duration-300'
        >
            <div
